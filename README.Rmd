...
(https://travis-ci.org/jaredlander/coefplot.svg?branch=master)](https://travis-ci.org/jaredlander/coefplot)
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/coefplot)](https://CRAN.R-project.org/package=coefplot)
[![Downloads from the RStudio CRAN mirror](http://cranlogs.r-pkg.org/badges/coefplot)](https://CRAN.R-project.org/package=coefplot)
